...
public final class ElectricityRequest extends ModbusRequest {
    ...
    public static final byte START_REGISTER_LOW = 0x4C;
    public static final byte REGISTER_COUNT_HIGH = 0x00;
    public static final byte REGISTER_COUNT_LOW = 0x01;
