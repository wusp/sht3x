...
public class Const {
    ...
    public static final String GPIO_CARD_READER_ENABLE = "/sys/class/gpio_sw/PH16/data"; //1:close 0:open
    public static final String GPIO_CARD_READER = "/sys/class/gpio_sw/PH15/data"; //1:close 0:open
