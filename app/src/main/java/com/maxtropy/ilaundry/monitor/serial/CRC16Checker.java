...
public class CRC16Checker {
     ...
     * @return 计算结果
     */
    public static int calculate(byte[] bytes, Integer length) {
        int crcValue = 0xFFFF;
        for (int i = 0; i < length; i++)
            crcValue = (crcValue >> 8) ^ TABLE[((crcValue) ^ (bytes[i] & 0xff)) & 0xff];
        return crcValue & 0x0000ffff;
    }
}
